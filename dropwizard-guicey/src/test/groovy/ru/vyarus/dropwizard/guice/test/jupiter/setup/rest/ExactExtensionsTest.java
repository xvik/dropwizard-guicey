...
import ru.vyarus.dropwizard.guice.test.jupiter.setup.rest.support.ErrorResource;
import ru.vyarus.dropwizard.guice.test.jupiter.setup.rest.support.ManagedBean;
import ru.vyarus.dropwizard.guice.test.jupiter.setup.rest.support.Resource1;
import ru.vyarus.dropwizard.guice.test.jupiter.setup.rest.support.Resource2;
import ru.vyarus.dropwizard.guice.test.jupiter.setup.rest.support.RestExceptionMapper;
import ru.vyarus.dropwizard.guice.test.jupiter.setup.rest.support.RestFilter1;
import ru.vyarus.dropwizard.guice.test.jupiter.setup.rest.support.RestFilter2;
import ru.vyarus.dropwizard.guice.test.jupiter.setup.rest.support.RestStubApp;
import ru.vyarus.dropwizard.guice.test.jupiter.setup.rest.support.WebFilter;
...
public class ExactExtensionsTest {
