...
import ru.vyarus.dropwizard.guice.test.jupiter.guicey.ManualRegInjectOnceGuiceyTest;
...
public class ManualRegInjectOnceDwTest {


    @RegisterExtension
    TestDropwizardAppExtension app = TestDropwizardAppExtension.forApp(ManualRegInjectOnceGuiceyTest.App.class)
            .injectOnce()
            .debug()
            .create();
