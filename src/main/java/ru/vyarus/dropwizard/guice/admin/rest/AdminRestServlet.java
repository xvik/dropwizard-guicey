 ...
 * <p>Marks request with custom attribute {@link #ADMIN_PROPERTY} to indicate admin rest usage.
 * It may be used later to recognize rest origin. For example, {@link AdminResourceFilter} use it to prevent
 * access to admin resources (annotated with {@link AdminResource}) from user context.</p>
 *
