...
import ru.vyarus.dropwizard.guice.support.provider.InjectableProviderCheckApplication2
 ...
 * @since 25.11.2014
 */
class InjectableProviderHKTest extends AbstractTest {
    ...
    DropwizardAppRule<TestConfiguration> RULE =
            new DropwizardAppRule<TestConfiguration>(InjectableProviderCheckApplication2.class, 'src/test/resources/ru/vyarus/dropwizard/guice/config.yml');
