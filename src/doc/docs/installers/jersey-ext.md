...
Useful for [error handling customization](http://www.dropwizard.io/1.1.0/docs/manual/core.html#error-handling).
...
Useful for [custom representations](http://www.dropwizard.io/1.1.0/docs/manual/core.html#custom-representations).
...
Useful for [request modifications](http://www.dropwizard.io/1.1.0/docs/manual/core.html#jersey-filters).
...
Useful for [response modifications](http://www.dropwizard.io/1.1.0/docs/manual/core.html#jersey-filters).
...
Useful for conditional [activation of filters](http://www.dropwizard.io/1.1.0/docs/manual/core.html#jersey-filters).
