...
!!! abstract ""
    Example [source code](https://github.com/xvik/dropwizard-guicey/tree/dw-2.1/examples/ext-jdbi3)
...
!!! warning
    ...
    See [example app source](https://github.com/xvik/dropwizard-guicey/tree/dw-2.1/examples/ext-jdbi3) for details. 
