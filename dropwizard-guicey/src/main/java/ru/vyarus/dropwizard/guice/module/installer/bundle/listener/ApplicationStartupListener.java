 ...
 * Supposed to be used instead of {@link io.dropwizard.lifecycle.ServerLifecycleListener} (because server listener
 * is not called for guicey lightweight tests) and instead of
 * {@link org.eclipse.jetty.util.component.LifeCycle.Listener} in cases when only startup event is important
 * (easier to use).
 * <p>
