...
```groovy
implementation 'ru.vyarus.guicey:guicey-server-pages:{guicey.version}'
```
...
IMPORTANT: GSP errors handling override [ExceptionMapper](https://www.dropwizard.io/en/release-3.0.x/manual/views.html#template-errors)
