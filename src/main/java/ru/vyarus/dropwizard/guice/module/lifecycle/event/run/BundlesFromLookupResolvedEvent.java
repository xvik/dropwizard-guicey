...
public class BundlesFromLookupResolvedEvent extends RunPhaseEvent {
    ...
    public BundlesFromLookupResolvedEvent(final OptionsInfo options,
                                          final Bootstrap bootstrap,
                                          final Configuration configuration,
                                          final Environment environment,
                                          final List<GuiceyBundle> bundles) {
        super(GuiceyLifecycle.BundlesFromLookupResolved, options, bootstrap, configuration, environment);
