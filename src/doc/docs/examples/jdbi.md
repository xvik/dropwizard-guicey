...
[dropwizard-jdbi](http://www.dropwizard.io/1.3.0/docs/manual/jdbi.html) is used to configure 
...
DBI instance created exactly as described in [dropwizard docs](http://www.dropwizard.io/1.3.0/docs/manual/jdbi.html) 
