 ...
 * @since 20.04.2025
 */
public class RestStubsRunner implements GuiceyConfigurationHook {

    private final StubRestConfig config;
    private GuiceyJerseyTest jerseyStub;
    private RestClient restClient;

    public RestStubsRunner(final StubRestConfig config) {
        this.config = config;
    }
    ...
    public static class Builder {
        ...
        public RestStubsRunner build() {
            return new RestStubsRunner(config);
        }
    }
}
