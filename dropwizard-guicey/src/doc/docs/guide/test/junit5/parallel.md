...
could be activated with the properties file `junit-platform.properties` located at the test resources root:
...
To avoid port collisions in Dropwizard tests, use the [randomPorts option](run.md#random-ports).