 ...
 * <ul>
 *     <li>For system exit capturing you can use https://github.com/tginsberg/junit5-system-exit</li>
 *     <li>For system streams capturing there is no alternatives, but in any case it is impossible to do for parallel
 *     tests</li>
 * </ul>
 *
