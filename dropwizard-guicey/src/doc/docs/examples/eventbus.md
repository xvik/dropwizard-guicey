...
!!! abstract ""
    Example [source code](https://github.com/xvik/dropwizard-guicey/tree/dw-2.1/examples/ext-eventbus)
...
See [a complete example](https://github.com/xvik/dropwizard-guicey/tree/dw-2.1/examples/ext-eventbus)         