 ...
 * @since 05.03.2025
 */
@TestGuiceyApp(value = AutoScanApplication.class, configModifiers = ConfigModifyWithClassGuiceyTest.FooModifier.class,
        configOverride = {"foo: 2", "bar: 3", "baa: 4"})
public class ConfigModifyWithClassGuiceyTest {
