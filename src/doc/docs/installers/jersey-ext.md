...
Useful for [error handling customization](https://www.dropwizard.io/en/release-1.3.x/manual/core.html#error-handling).
...
Useful for [custom representations](https://www.dropwizard.io/en/release-1.3.x/manual/core.html#custom-representations).
...
Useful for [request modifications](https://www.dropwizard.io/en/release-1.3.x/manual/core.html#jersey-filters).
...
Useful for [response modifications](https://www.dropwizard.io/en/release-1.3.x/manual/core.html#jersey-filters).
...
Useful for conditional [activation of filters](https://www.dropwizard.io/en/release-1.3.x/manual/core.html#jersey-filters).
